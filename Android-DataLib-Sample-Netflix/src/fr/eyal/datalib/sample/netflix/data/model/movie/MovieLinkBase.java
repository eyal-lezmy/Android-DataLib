...
public class MovieLinkBase extends BusinessObjectDAO {
    ...
    public MovieLinkBase() {
        super();
    }

    public MovieLinkBase(final long id) {
        super(id);
    }
     ...
     */
    public static final String CONTENT_PATH = "movielink";
     ...
     */
    public static String DATABASE_TABLE_NAME = "movielink";
    ...
    protected void fillFromDatabaseById(final long id) {
        ...
        final Cursor cursor = mResolver.query(CONTENT_URI, // MovieLink
                columns, // id
                where, // id=?
                args, // id
	...
	/**
     * This function build an array of {@link MovieLinkBase} thanks to a Cursor
     ...
     *  	   Ex: Cast to ArrayList<{@link MovieLink}> if you want it as {@link MovieLink}
     */
    public static ArrayList<?> buildArrayFromCursor(final Cursor c, final boolean join) {

        final ArrayList<MovieLinkBase> result = new ArrayList<MovieLinkBase>();

        if (c.moveToFirst()) {
            do {
                // we create and fill the item
                final MovieLinkBase newObject = new MovieLinkBase();
	...
	public static final Parcelable.Creator<MovieLinkBase> CREATOR = new Parcelable.Creator<MovieLinkBase>() {
	    @Override
	    public MovieLinkBase createFromParcel(final Parcel in) {
	        return new MovieLinkBase(in);
	    }
	
	    @Override
	    public MovieLinkBase[] newArray(final int size) {
	        return new MovieLinkBase[size];
	    }
	};
	...
	public MovieLinkBase(final Parcel in) {
		// Business Object DAO
		_id = in.readLong();
		_updatedAt = Calendar.getInstance();
