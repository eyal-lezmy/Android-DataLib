...
// Start of user code DirectorsConfig imports
// You can add here your personal imports
// DO NOT MODIFY THE GENERATED COMMENTS "Start of user code" and "End of user code

public class DirectorsWebConfig extends DataLibWebConfig {

    protected static DirectorsWebConfig sInstance; //Singleton of the WebConfig

    public static DirectorsWebConfig getInstance() {
        synchronized (DirectorsWebConfig.class) {
	        if (sInstance == null) {
	            sInstance = new DirectorsWebConfig();
	        }
		}
        return (DirectorsWebConfig) sInstance;
    }

    private DirectorsWebConfig() {}
...
// Start of user code DirectorsConfig
