...
public class CastLinkBase extends BusinessObjectDAO {
    ...
    public CastLinkBase(final long id) {
        super(id);
    }
     ...
     */
    public static final String CONTENT_PATH = "castlink";
     ...
     */
    public static String DATABASE_TABLE_NAME = "castlink";
    ...
    protected void fillFromDatabaseById(final long id) {
        ...
        final Cursor cursor = mResolver.query(CONTENT_URI, // CastLink
                columns, // id
                where, // id=?
                args, // id
