...
// Start of user code NetflixDataManager
	...
	public synchronized int getMovie(final int policy, final OnDataListener datacacheListener, final String type, final int movie_id, final int options, ComplexOptions complexOptionsCache, ComplexOptions complexOptionsNetwork) throws UnsupportedEncodingException {
		...
		final ParameterMap params = getOAuthParameterMap();
     ...
     * @throws UnsupportedEncodingException
     */
	public synchronized int getCast(final int policy, final OnDataListener datacacheListener, final int movie_id, final int options, ComplexOptions complexOptionsCache, ComplexOptions complexOptionsNetwork) throws UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException
     */
	public synchronized int getCatalogTitles(final OnDataListener datacacheListener, final int max_results, final int start_index, final String term, final int options, ComplexOptions complexOptionsNetwork) throws UnsupportedEncodingException {
	...
	/**
	 * Get {@link ParameterMap} following the OAuth API keys
	 * 
	 * @return the created ParameterMap
	 */
	public ParameterMap getOAuthParameterMap() {
