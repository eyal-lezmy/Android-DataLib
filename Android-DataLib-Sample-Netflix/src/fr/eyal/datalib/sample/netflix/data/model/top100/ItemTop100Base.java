...
public class ItemTop100Base extends BusinessObjectDAO {
    ...
    public ItemTop100Base() {
        super();
    }

    public ItemTop100Base(final long id) {
        super(id);
    }
     ...
     */
    public static final String CONTENT_PATH = "itemtop100";
     ...
     */
    public static String DATABASE_TABLE_NAME = "itemtop100";
    ...
    public static String CREATE_TABLE = "CREATE TABLE " + DATABASE_TABLE_NAME + " (" 
            ...
            + Top100.DATABASE_TABLE_NAME + "(" + Top100.DATABASE_TABLE_FIELDS_NAMES[0] + ") ON DELETE CASCADE" + ", "
    ...
    protected void fillFromDatabaseById(final long id) {
        ...
        final Cursor cursor = mResolver.query(CONTENT_URI, // ItemTop100
                columns, // id
                where, // id=?
                args, // id
	...
	/**
     * This function build an array of {@link ItemTop100Base} thanks to a Cursor
     ...
     *  	   Ex: Cast to ArrayList<{@link ItemTop100}> if you want it as {@link ItemTop100}
     */
    public static ArrayList<?> buildArrayFromCursor(final Cursor c, final boolean join) {

        final ArrayList<ItemTop100Base> result = new ArrayList<ItemTop100Base>();

        if (c.moveToFirst()) {
            do {
                // we create and fill the item
                final ItemTop100Base newObject = new ItemTop100Base();
	...
	public static final Parcelable.Creator<ItemTop100Base> CREATOR = new Parcelable.Creator<ItemTop100Base>() {
	    @Override
	    public ItemTop100Base createFromParcel(final Parcel in) {
	        return new ItemTop100Base(in);
	    }
	
	    @Override
	    public ItemTop100Base[] newArray(final int size) {
	        return new ItemTop100Base[size];
	    }
	};
	...
	public ItemTop100Base(final Parcel in) {
		// Business Object DAO
		_id = in.readLong();
		_updatedAt = Calendar.getInstance();
