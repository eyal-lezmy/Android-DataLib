...
public class FilmographyLinkBase extends BusinessObjectDAO {
    ...
    public FilmographyLinkBase(final long id) {
        super(id);
    }
     ...
     */
    public static final String CONTENT_PATH = "filmographylink";
     ...
     */
    public static String DATABASE_TABLE_NAME = "filmographylink";
    ...
    protected void fillFromDatabaseById(final long id) {
        ...
        final Cursor cursor = mResolver.query(CONTENT_URI, // FilmographyLink
                columns, // id
                where, // id=?
                args, // id
	...
	/**
     * This function build an array of {@link FilmographyLinkBase} thanks to a Cursor
     ...
     *  	   Ex: Cast to ArrayList<{@link FilmographyLink}> if you want it as {@link FilmographyLink}
     */
    public static ArrayList<?> buildArrayFromCursor(final Cursor c, final boolean join) {

        final ArrayList<FilmographyLinkBase> result = new ArrayList<FilmographyLinkBase>();

        if (c.moveToFirst()) {
            do {
                // we create and fill the item
                final FilmographyLinkBase newObject = new FilmographyLinkBase();
	...
	public static final Parcelable.Creator<FilmographyLinkBase> CREATOR = new Parcelable.Creator<FilmographyLinkBase>() {
	    @Override
	    public FilmographyLinkBase createFromParcel(final Parcel in) {
	        return new FilmographyLinkBase(in);
	    }
	
	    @Override
	    public FilmographyLinkBase[] newArray(final int size) {
	        return new FilmographyLinkBase[size];
	    }
	};
	...
	public FilmographyLinkBase(final Parcel in) {
		// Business Object DAO
		_id = in.readLong();
		_updatedAt = Calendar.getInstance();
