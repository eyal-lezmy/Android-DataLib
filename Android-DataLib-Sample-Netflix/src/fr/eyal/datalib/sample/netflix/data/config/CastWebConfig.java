...
// Start of user code CastConfig imports
// You can add here your personal imports
// DO NOT MODIFY THE GENERATED COMMENTS "Start of user code" and "End of user code

public class CastWebConfig extends DataLibWebConfig {

    protected static CastWebConfig sInstance; //Singleton of the WebConfig

    public static CastWebConfig getInstance() {
        synchronized (CastWebConfig.class) {
	        if (sInstance == null) {
	            sInstance = new CastWebConfig();
	        }
		}
        return (CastWebConfig) sInstance;
    }

    private CastWebConfig() {}
