...
import fr.eyal.lib.datalib.genmodel.android.datalib.content.*;
...
public class ContentFactoryImpl extends EFactoryImpl implements ContentFactory {
	...
	public static ContentFactory init() {
		try {
			ContentFactory theContentFactory = (ContentFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eyal.fr/android/datalib/content"); 
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ContentPackage.PARSE_TYPE:
				return createParseTypeFromString(eDataType, initialValue);
			case ContentPackage.HTTP_METHOD:
				return createHttpMethodFromString(eDataType, initialValue);
			case ContentPackage.DATA_LIB_OPTION:
				return createDataLibOptionFromString(eDataType, initialValue);
			case ContentPackage.PARAMETER_TYPE:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ContentPackage.DATA_LIB_OPTION:
				return convertDataLibOptionToString(eDataType, instanceValue);
			case ContentPackage.PARAMETER_TYPE:
	 ...
	 * @generated
	 */
	public DataLibOption createDataLibOptionFromString(EDataType eDataType, String initialValue) {
		DataLibOption result = DataLibOption.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertDataLibOptionToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
